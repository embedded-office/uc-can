...
#if (APP_CAN_DEMO_SELECT == APP_CAN_RX_TX_DEMO)
static  OS_STK      App_CAN_RxTaskStk[APP_CFG_CAN_RX_TASK_STK_SIZE];
static  OS_STK      App_CAN_TxTaskStk[APP_CFG_CAN_TX_TASK_STK_SIZE];

        CPU_INT08U  DemoCnt = 0u;
#endif

#if (APP_CAN_DEMO_SELECT == APP_CAN_ECHO_DEMO)
static  OS_STK      App_CAN_EchoTaskStk[APP_CFG_CAN_RX_TASK_STK_SIZE];
#endif
...
void  App_CAN_Startup (void)
{
...
#if (APP_CAN_DEMO_SELECT == APP_CAN_RX_TX_DEMO)
#if (OS_STK_GROWTH == 1u)
    OSTaskCreateExt( Rx_Task,                                   /* Create CAN Rx Task.                                  */
                     0u,
                    &App_CAN_RxTaskStk[APP_CFG_CAN_RX_TASK_STK_SIZE - 1u],
    ...
    OSTaskCreateExt( Rx_Task,                                   /* Create CAN Rx Task.                                  */
                    ...
                    &App_CAN_RxTaskStk[APP_CFG_CAN_RX_TASK_STK_SIZE -1u],
                     ...
                     0u,
                    (OS_TASK_OPT_STK_CHK | OS_TASK_OPT_STK_CLR));
#if OS_TASK_NAME_EN > 0                                         /* Set Rx Task Name.                                    */
        OSTaskNameSet( APP_CFG_CAN_RX_TASK_PRIO,
                      "CAN Rx Demo",
                      &os_err);
#endif                                                          /* End of OS_TASK_NAME_EN > 0 check                     */
#endif                                                          /* End of OS_STK_GROWTH == 1 check                      */

#if (OS_STK_GROWTH == 1u)
    OSTaskCreateExt( Tx_Task,                                   /* Create CAN Tx Task.                                  */
                     0u,
                    &App_CAN_TxTaskStk[APP_CFG_CAN_TX_TASK_STK_SIZE - 1u],
    ...
    OSTaskCreateExt( Tx_Task,                                   /* Create CAN Tx Task.                                  */
                    ...
                    &App_CAN_TxTaskStk[APP_CFG_CAN_TX_TASK_STK_SIZE - 1u],
                     ...
                     0u,
                    (OS_TASK_OPT_STK_CHK | OS_TASK_OPT_STK_CLR));
#if OS_TASK_NAME_EN > 0                                         /* Set Tx Task Name.                                    */
        OSTaskNameSet( APP_CFG_CAN_TX_TASK_PRIO,
                      "CAN Tx Demo",
                      &os_err);
#endif                                                          /* End of OS_TASK_NAME_EN > 0 check                     */
#endif                                                          /* End of OS_STK_GROWTH == 1 check                      */
...
#if (APP_CAN_DEMO_SELECT == APP_CAN_ECHO_DEMO)
#if (OS_STK_GROWTH == 1u)
    OSTaskCreateExt( Echo_Task,                                 /* Create CAN Echo Task.                                */
                     0u,
                    &App_CAN_EchoTaskStk[APP_CFG_CAN_RX_TASK_STK_SIZE - 1u],
                     APP_CFG_CAN_RX_TASK_PRIO,
                     APP_CFG_CAN_RX_TASK_PRIO,
    ...
    OSTaskCreateExt( Echo_Task,                                 /* Create CAN Echo Task.                                */
                    ...
                    &App_CAN_EchoTaskStk[APP_CFG_CAN_RX_TASK_STK_SIZE -1u],
                     ...
                     0u,
                    (OS_TASK_OPT_STK_CHK | OS_TASK_OPT_STK_CLR));
#if OS_TASK_NAME_EN > 0                                         /* Set Echo Task Name.                                  */
        OSTaskNameSet( APP_CFG_CAN_RX_TASK_PRIO,
                      "CAN Echo Demo",
                      &os_err);
#endif                                                          /* End of OS_TASK_NAME_EN > 0 check                     */
#endif                                                          /* End of OS_STK_GROWTH == 1 check                      */
#endif                                                          /* End APP_CAN_DEMO_SELECT == APP_CAN_ECHO_DEMO         */
}
