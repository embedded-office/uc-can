...
#define LPC24XX_CAN_NAME "LPC24XX:CAN Module"
...
#define LPC24XX_CAN_RTR_FRAME_BIT   0x40000000
#define LPC24XX_CAN_FF_FRAME_BIT    0x20000000
/*
***************************************************************************************************
*                            TYPE DEFINITIONS
***************************************************************************************************
...
enum
{
  LPC24XX_CAN_BUS_0,                                  /*  Internal can controller #0              */
  LPC24XX_CAN_BUS_1,                                  /*  Internal can controller #1              */
  LPC24XX_CAN_N_DEV                                   /*  Number of used can controller           */
};
...
enum  {
     ...
     */
    IO_LPC24XX_CAN_SET_BAUDRATE = 0x10,
    /*! \brief Enable Bus
     *
    ...
    *
     * The parameter pointer is not used for this function.
     */
    IO_LPC24XX_CAN_SET_STD_GROUP_FILTER,
...
CPU_INT16S LPC24XXCANOpen(CPU_INT16S drvId, CPU_INT32U devName, CPU_INT16U mode);
