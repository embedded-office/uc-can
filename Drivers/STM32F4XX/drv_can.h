...
#define STM32F4XX_CAN_NAME "STM32F4XX:CAN Module"
...
*/
/*------------------------------------------------------------------------------------------------*/
#define STM32F4XX_DEF_BAUDRATE      1000000L
...
*/
/*------------------------------------------------------------------------------------------------*/
#define STM32F4XX_FF_FRAME_BIT    0x20000000
#define STM32F4XX_RTR_FRAME_BIT   0x40000000
...
/*------------------------------------------------------------------------------------------------*/
enum {
    STM32F4XX_CAN_BUS_0,                              /*!< Internal CAN controller #0             */
    STM32F4XX_CAN_BUS_1,                              /*!< Internal CAN controller #1             */
    STM32F4XX_CAN_N_DEV                               /*!< Number of CAN controllers              */
};
...
enum {
    ...
    */
    /*--------------------------------------------------------------------------------------------*/
    IO_STM32F4XX_CAN_GET_IDENT    = 0x0,
    /*--------------------------------------------------------------------------------------------*/
    /*!
    ...
    */
    /*--------------------------------------------------------------------------------------------*/
    IO_STM32F4XX_CAN_SET_BAUDRATE = 0x10,
    /*--------------------------------------------------------------------------------------------*/
    /*!
    * \brief    ENABLE BUS
    *
    ...
    */
    /*--------------------------------------------------------------------------------------------*/
    IO_STM32F4XX_CAN_GET_NODE_STATUS,
    /*--------------------------------------------------------------------------------------------*/
    /*!
    ...
    */
    /*--------------------------------------------------------------------------------------------*/
    IO_STM32F4XX_CAN_SET_RX_FILTER_1,
    /*--------------------------------------------------------------------------------------------*/
    /*!
    ...
    */
    /*--------------------------------------------------------------------------------------------*/
    IO_STM32F4XX_CAN_SET_RX_FILTER_2,
    /*--------------------------------------------------------------------------------------------*/
    /*!
...
typedef struct {
    ...
    CPU_INT08U FilterIdx;                             /* index to address further filters         */
...
CPU_INT16S STM32F4XXCANOpen  (CPU_INT16S drvId, CPU_INT32U devName, CPU_INT16U mode);
...
CPU_INT16S STM32F4XXCAN_CalcTimingReg (STM32F4XX_CAN_DATA *data);
void       STM32F4XXCAN_PinCfg        (CPU_INT32U arg);
...
#if ((STM32F4XX_CAN_ARG_CHK_CFG) < 0 || (STM32F4XX_CAN_ARG_CHK_CFG > 1))
#error "STM32F4XX/drv_can.h : The configuration STM32F4XX_CAN_ARG_CHK_CFG must be 0 or 1"
#endif
