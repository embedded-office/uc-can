...
#define LM3S9B96_CAN_NAME "LM3S9B96:CAN Module"
...
#define LM3S9B96_CAN_RTR_FRAME_BIT   0x40000000
#define LM3S9B96_CAN_FF_FRAME_BIT    0x20000000
...
enum  {
     ...
     */
    IO_LM3S9B96_CAN_SET_BAUDRATE = 0x10,
    /*! \brief Enable Bus
     *
     ...
     * shall be written to.
     */
    IO_LM3S9B96_CAN_GET_NODE_STATUS,
    /*! \brief             SET RX FILTER
     *
...
enum
{
  LM3S9B96_CAN_BUS_0,                                          /*!< Internal can controller #0             */
  LM3S9B96_CAN_BUS_1,                                          /*!< Internal can controller #1             */
  LM3S9B96_CAN_N_DEV                                           /*!< Number of used can controller          */
};
...
CPU_INT16S LM3S9B96CANIoCtl   (CPU_INT16S paraId, CPU_INT16U func,    void* arg);
CPU_INT16S LM3S9B96CANRead    (CPU_INT16S paraId, CPU_INT08U *buffer,  CPU_INT16U cnt);
CPU_INT16S LM3S9B96CANWrite   (CPU_INT16S paraId, CPU_INT08U *buffer,  CPU_INT16U cnt);

#if LM3S9B96_CAN_INTERRUPT_EN > 0
void       LM3S9B96CANISR     (void);
#endif
